...
#Step 8: Summary statistics for 10nm wavelength bins from 300 to 700 nm
...
boxplot(data = wl_dataframe, Reflectance_Values~Wavelength_Bins, col = colors_for_plots, main = "Summary Statistics for Thraupidae (51 Species)", xlab = "Wavelength Bins (10nm Intervals)", ylab = "Reflectance (%)")

```


#Step 9: Spline Coefficient Extraction for BEAST
