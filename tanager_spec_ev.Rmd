...
ggplot(data = model_scoring, aes(x = Natural_AIC, y = Cubic_AIC, color = Species)) + geom_point() + theme(legend.key.size = unit(0.5, "cm")) + geom_abline(intercept = 0, slope = 1) + xlab("Natural AIC Score") + ylab("Cubic AIC Score") + ggtitle("AIC Scores", subtitle = "Cubic vs. Natural Splines")


ggplot(data = model_scoring, aes(x = Natural_Adj_R2, y = Cubic_Adj_R2, color = Species)) + geom_point() + theme(legend.key.size = unit(0.5, "cm")) + geom_abline(intercept = 0, slope = 1) + xlab("Natural R^2 Score") + ylab("Cubic R^2 Score") + ggtitle("R^2 Scores", subtitle = "Cubic vs. Natural Splines")
