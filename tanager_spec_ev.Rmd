...
what <- read.delim("C:/Users/batra/Box/BEAST Output/Spline_XML_Output_1.30.25/what", header=FALSE)

barplot(1/as.numeric(c(what[2, 2:40])), ylim = c(0,35), names.arg = coefficient_names[2:40])
```
