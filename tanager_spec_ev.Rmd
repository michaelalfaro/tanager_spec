...
treepath <- "C:/Users/batra/Documents/tanager_spec/tanager_spec/data/MCC_Tree_SpNames.nex"
...
# Exporting DATA to BEAST

```{r}


reflectance_spline_coefficients_exports <- spline_table[,1:2]

write.csv(reflectance_spline_coefficients_exports, file = "test.csv")


x <- c(reflectance_spline_coefficients_exports$Reflectance_Spline_Coefficients[1])

as.numeric(x)

log_reflectance_spline_coefficients_exports <-
