...
length(colors_for_plots, )

# Boxplot of the reflectance data for each wavelength bin
boxplot(data = wl_dataframe, Reflectance_Values~Wavelength_Bins, col = binned_wl_color, main = "Summary Statistics for Thraupidae Crown Reflectance (51 Species)", xlab = "Wavelength Bins (10nm Intervals)", ylab = "Reflectance (%)")
...
binned_reflectance_vector <- rep(0, 401)
binned_reflectance_vector[200:209] <- 100
binned_reflectance_vector
binned_reflectance_vector <- cbind(300:700, binned_reflectance_vector)
colnames(binned_reflectance_vector) <- c("wl", "reflectance")
binned_reflectance_vector <- data.frame(binned_reflectance_vector)
binned_reflectance_vector
binned_reflectance_vector <- as.rspec(binned_reflectance_vector)
spec2rgb(binned_reflectance_vector, alpha = 0.05)
```