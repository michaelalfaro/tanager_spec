...
# Initialize vectors to store standard deviations
...
plot(tanData_filtered$wl, natural_spline_avg, type = "l", col = "blue", lwd = 2,
...
lines(tanData_filtered$wl, natural_spline_avg, col = "blue", lwd = 2)

# Create a plot for the average cubic spline with confidence intervals
plot(tanData_filtered$wl, cubic_spline_avg, type = "l", col = "green", lwd = 2,
...
# Average Cubic Spline with Hotspots
plot(tanData_filtered$wl, cubic_spline_avg, type = "l", col = "green", lwd = 2,
     main = "Average Cubic Spline with Variation Hotspots",
     xlab = "Wavelength (nm)", ylab = "Reflectance", ylim = c(0, max_reflectance))
polygon(c(tanData_filtered$wl, rev(tanData_filtered$wl)), 
...
# Plot Natural Spline Mean
plot(tanData_filtered$wl, natural_spline_avg, type = "l", col = "blue", lwd = 2,
     main = "Natural Spline Mean with Species Overlaid",
     xlab = "Wavelength (nm)", ylab = "Reflectance", ylim = c(0, max_reflectance))
for (i in seq_along(spline_results)) {
  lines(tanData_filtered$wl, predict(spline_results[[i]]$natural_spline_fit), col = rgb(0, 0, 1, 0.3))
}
lines(tanData_filtered$wl, natural_spline_avg, col = "blue", lwd = 2)

# Plot Cubic Spline Mean
plot(tanData_filtered$wl, cubic_spline_avg, type = "l", col = "green", lwd = 2,
     main = "Cubic Spline Mean with Species Overlaid",
     xlab = "Wavelength (nm)", ylab = "Reflectance", ylim = c(0, max_reflectance))
for (i in seq_along(spline_results)) {
  lines(tanData_filtered$wl, predict(spline_results[[i]]$cubic_spline_fit), col = rgb(0, 1, 0, 0.3))
}
lines(tanData_filtered$wl, cubic_spline_avg, col = "green", lwd = 2)
...
### Step 4b: Plot Natural and Cubic Splines with Species Overlaid (Side by Side)
